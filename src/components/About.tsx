...
export default function About({data}: AboutProps) {
  ...
  // Stats data with numeric values for AnimatedCounter
  const stats = [
    {
      value: 5,
      suffix: '+',
    ...
    {
      value: githubStats?.totalStars ?? 50,
      suffix: '+',
      label: 'GitHub Stars Earned',
      color: 'from-purple-500 to-pink-600',
    },
    {
      value: githubStats?.followers ?? 100,
      suffix: '+',
          ...
          >
            ...
            <motion.div variants={staggerItem} className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                The story behind the code—my journey, passion, and what makes me tick as a
                developer
              </p>
            </motion.div>
            ...
            <div className="grid lg:grid-cols-3 gap-8 lg:gap-12">
              {/* Left Column - Profile Image & Quick Info with Tilt Effect */}
              <motion.div variants={staggerItem} className="lg:col-span-1">
                <TiltCard maxTilt={10} glare shadow className="sticky top-24">
                      ...
                      <div className="space-y-4">
                        ...
                        {contactDetails.map((detail) => {
                          ...
                          return detail.href ? (
                            ...
                            <div key={detail.label} className="block -mx-3 px-3 py-2">
                              {content}
                            </div>
                          );
                        })}
                      ...
                      <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {techStack.map((tech, index) => (
                            <FloatingBadge key={tech} delay={index * 0.15}>
                              {tech}
                            </FloatingBadge>
                          ))}
                        </div>
